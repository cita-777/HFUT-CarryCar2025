...
void Class_AHRS_WIT::Data_Process(uint16_t Length)
{
    ...
    for (int i = 0; i < Length;)
    {
        ...
        {
            Data_Accelerate.Accelerate_X =
                (int16_t)(tmp_buffer->Data[0] | tmp_buffer->Data[1] << 8) / 32768.0f * 16.0f * 9.8f;

            Data_Accelerate.Accelerate_Y =
                (int16_t)(tmp_buffer->Data[2] | tmp_buffer->Data[3] << 8) / 32768.0f * 16.0f * 9.8f;

            Data_Accelerate.Accelerate_Z =
                (int16_t)(tmp_buffer->Data[4] | tmp_buffer->Data[5] << 8) / 32768.0f * 16.0f * 9.8f;

            Data_Accelerate.Temperature =
                (int16_t)(tmp_buffer->Data[6] | tmp_buffer->Data[7] << 8) / 100.0f + CELSIUS_TO_KELVIN;
        ...
        {
            Data_Omega.Omega_X =
                (int16_t)(tmp_buffer->Data[0] | tmp_buffer->Data[1] << 8) / 32768.0f * 2000.0f * DEG_TO_RAD;

            Data_Omega.Omega_Y =
                (int16_t)(tmp_buffer->Data[2] | tmp_buffer->Data[3] << 8) / 32768.0f * 2000.0f * DEG_TO_RAD;

            Data_Omega.Omega_Z =
                (int16_t)(tmp_buffer->Data[4] | tmp_buffer->Data[5] << 8) / 32768.0f * 2000.0f * DEG_TO_RAD;
