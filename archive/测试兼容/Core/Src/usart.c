...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = BoardA_UART7_Tx_Pin|BoardA_UART7_Rx_Pin;
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = BoardA_DBUS_Idle_Pin|BoardA_DBUS_Rx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = BoardA_Bluetooth_Tx_Pin|BoardA_Bluetooth_Rx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = BoardA_USART3_Tx_Pin|BoardA_USART3_Rx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = BoardA_USART6_Tx_Pin|BoardA_USART6_Rx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, BoardA_UART7_Tx_Pin|BoardA_UART7_Rx_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, BoardA_DBUS_Idle_Pin|BoardA_DBUS_Rx_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, BoardA_Bluetooth_Tx_Pin|BoardA_Bluetooth_Rx_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, BoardA_USART3_Tx_Pin|BoardA_USART3_Rx_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, BoardA_USART6_Tx_Pin|BoardA_USART6_Rx_Pin);
